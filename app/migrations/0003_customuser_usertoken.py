...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0002_remove_profile_date_modifies_profile_date_modified_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.emailverificationtoken')),
